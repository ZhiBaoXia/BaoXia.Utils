...
public class ListsCacheAsyncTester<ListIdType>(
	string testName,
	Func<ListIdType> toDidCreateListId) where ListIdType : IComparable
{
	////////////////////////////////////////////////
	// @自身属性
	////////////////////////////////////////////////
	...
	protected Func<ListIdType> _toDidCreateListId = toDidCreateListId;
