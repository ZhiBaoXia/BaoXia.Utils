        ...
        public class DateTimeSectionTest
        {
                ...
                public void IsTimeInSectionWith_NotLoop_AscTimeSection_Test()
                {
                        ...
                        var testCases = new (DateTime Time, bool TestResult)[]
                        {
                                ...
                                (Time: new DateTime(2023, 10, 18, 20, 00, 0), TestResult: true),
                                (Time: new DateTime(2023, 10, 18, 21, 00, 0), TestResult: true),
                                (Time: new DateTime(2023, 10, 18, 22, 0, 0), TestResult: true),
                                (Time: new DateTime(2023, 10, 18, 23, 00, 0), TestResult: false),
                ...
                public void IsTimeInSectionWith_NotLoop_DescTimeSection_Test()
                {
                        ...
                        var testCases = new (DateTime Time, bool TestResult)[]
                        {
                                (Time: new DateTime(2023, 10, 17, 21, 0, 0), TestResult: false),
                                (Time: new DateTime(2023, 10, 18, 12, 0, 0), TestResult: false),
                                (Time: new DateTime(2023, 10, 18, 20, 00, 0), TestResult: false),
                                (Time: new DateTime(2023, 10, 18, 21, 00, 0), TestResult: false),
