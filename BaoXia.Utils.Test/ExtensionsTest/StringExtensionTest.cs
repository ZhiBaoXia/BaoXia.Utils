...
public class StringExtensionTest
{
	...
	public void StringWithStringsTest()
	{
		...
		var stringAfterJoin = StringExtension.StringWithStrings(
			strings);
		{
	...
	public void StringWithIntsTest()
	{
		...
		var numbersString = StringExtension.StringWithInts(numbers);
		{
			...
			numberArray = new int[] { 0, 1, 2 };
			Assert.IsTrue(numbers.IsNotEquals(numberArray));

		}
		numbersString = StringExtension.StringWithInts(numbers, "|");
		{
			Assert.IsTrue(numbersString == "0|1|2|3|4|5");
			var numberArray = numbersString.ToIntArray("|");
			Assert.IsTrue(numbers.IsEquals(numberArray));
		...
		numbersString = StringExtension.StringWithInts(numbers, null);
		{
			Assert.IsTrue(numbersString == "012345");
		}
		numbersString = StringExtension.StringWithInts(numbers, ",", "D2");
		{
	...
	public void StringWithLongsTest()
	{
		...
		var numbersString = StringExtension.StringWithLongs(numbers);
		{
			Assert.IsTrue(numbersString == "0,1,2,3,4,5");
			var numberArray = numbersString.ToLongArray();
			Assert.IsTrue(numbers.IsEquals(numberArray));
			numberArray = new long[] { 0, 1, 2 };
			Assert.IsTrue(numbers.IsNotEquals(numberArray));
		}
		numbersString = StringExtension.StringWithLongs(numbers, "|");
		{
			Assert.IsTrue(numbersString == "0|1|2|3|4|5");
			var numberArray = numbersString.ToLongArray("|");
			Assert.IsTrue(numbers.IsEquals(numberArray));
		...
		numbersString = StringExtension.StringWithLongs(numbers, null);
		{
			Assert.IsTrue(numbersString == "012345");
		}
		numbersString = StringExtension.StringWithLongs(numbers, ",", "D2");
		{
			Assert.IsTrue(numbersString == "00,01,02,03,04,05");
			var numberArray = numbersString.ToLongArray();
			Assert.IsTrue(numbers.IsEquals(numberArray));
	...
	public void StringWithFloatsTest()
	{
		...
		var numbersString = StringExtension.StringWithFloats(numbers);
		{
			Assert.IsTrue(numbersString == "0,1.4,2.5,3.4,4.5,5.4");
			var numberArray = numbersString.ToFloatArray();
			Assert.IsTrue(numbers.IsEquals(numberArray));
			numberArray = new float[] { 0.0F, 1.4F, 2.5F };
			Assert.IsTrue(numbers.IsNotEquals(numberArray));
		}
		numbersString = StringExtension.StringWithFloats(numbers, "|");
		{
			Assert.IsTrue(numbersString == "0|1.4|2.5|3.4|4.5|5.4");
			var numberArray = numbersString.ToFloatArray("|");
			Assert.IsTrue(numbers.IsEquals(numberArray));
		...
		numbersString = StringExtension.StringWithFloats(numbers, null);
		{
			Assert.IsTrue(numbersString == "01.42.53.44.55.4");
		}
		numbersString = StringExtension.StringWithFloats(numbers, ",", "F2");
		{
	...
	public void StringWithDoublesTest()
	{
		...
		var numbersString = StringExtension.StringWithDoubles(numbers);
		{
			Assert.IsTrue(numbersString == "0,1.4,2.5,3.4,4.5,5.4");
			var numberArray = numbersString.ToDoubleArray();
			Assert.IsTrue(numbers.IsEquals(numberArray));
			numberArray = new double[] { 0.0, 1.4, 2.5 };
			Assert.IsTrue(numbers.IsNotEquals(numberArray));
		}
		numbersString = StringExtension.StringWithDoubles(numbers, "|");
		{
			Assert.IsTrue(numbersString == "0|1.4|2.5|3.4|4.5|5.4");
			var numberArray = numbersString.ToDoubleArray("|");
			Assert.IsTrue(numbers.IsEquals(numberArray));
		...
		numbersString = StringExtension.StringWithDoubles(numbers, null);
		{
			Assert.IsTrue(numbersString == "01.42.53.44.55.4");
		}
		numbersString = StringExtension.StringWithDoubles(numbers, ",", "F2");
		{
			Assert.IsTrue(numbersString == "0.00,1.40,2.50,3.40,4.50,5.40");
			var numberArray = numbersString.ToDoubleArray();
			Assert.IsTrue(numbers.IsEquals(numberArray));
