...
public class LogFileTest
{
	...
	public void InitializeAndRecordTest()
	{
		...
		//
		Assert.IsGreaterThan(0, logFilePathes?.Length ?? 0);
		//
		...
		//
		Assert.Contains(logContentKeywords, logFileContent);
		//
	...
	public void KeysInLogContentToIgnoreLogsTest()
	{
		...
		//
		// !!!
		Assert.AreNotEqual(true, logFileContent.Contains(keyInLogContentToIgnoreLog));
		// !!!
