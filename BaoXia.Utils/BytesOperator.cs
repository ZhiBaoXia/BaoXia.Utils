...
namespace BaoXia.Utils
{
	public class BytesOperator
	{
		...
		public DateTime ReadDateTime()
		{
			...
			var dateTime = DateTimeExtension
				.DateTimeWithMillisecondsFrom1970(dateTimeStamp);
			{ }
			return dateTime;
		}
		...
		public bool TryToReadDateTime(out DateTime dateTimeValue)
		{
			...
			// !!!
			dateTimeValue = DateTimeExtension.DateTimeWithMillisecondsFrom1970(dateTimeStamp);
			// !!!
			return true;
		}
