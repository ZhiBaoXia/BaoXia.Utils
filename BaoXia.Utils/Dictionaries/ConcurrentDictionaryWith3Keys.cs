	...
	where ThirdaryDeictionaryKeyType : notnull
{
	...
	public readonly ConcurrentDictionary<PrimaryDeictionaryKeyType,
		ConcurrentDictionary<SecondaryDeictionaryKeyType,
			ConcurrentDictionary<ThirdaryDeictionaryKeyType, ItemIndexNode<ItemType>>>> PrimaryDictionaries = new();
	...
	public ConcurrentDictionary<SecondaryDeictionaryKeyType,
		ConcurrentDictionary<ThirdaryDeictionaryKeyType, ItemIndexNode<ItemType>>>? GetSecondaryDictionaries(PrimaryDeictionaryKeyType primaryDeictionaryKey)
	{
	...
	public ConcurrentDictionary<ThirdaryDeictionaryKeyType, ItemIndexNode<ItemType>>? GetThirdaryDictionaries(
