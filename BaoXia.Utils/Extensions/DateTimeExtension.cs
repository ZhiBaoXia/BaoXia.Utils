...
namespace BaoXia.Utils.Extensions
{
        ...
        public static class DateTimeExtension
        {
                ...
                public static string ToListElementCaptionDefault(
                        this DateTime dateTime,
                        bool isNeedSecondsField = false)
                {
                        ...
                        if (dateTime.EqualsInDay(now))
                        {
                                ...
                                {
                                        caption = dateTime.ToString("今日 HH:mm:ss");
                                }
                                else
                                {
                                        caption = dateTime.ToString("今日 HH:mm");
                                }
                        }
                        else if (dateTime.IsYesterdayOf(now))
                        {
                                if (isNeedSecondsField)
                                {
                                        caption = dateTime.ToString("昨日 HH:mm:ss");
                                }
                                else
                                {
                                        caption = dateTime.ToString("昨日 HH:mm");
                                }
                        }
                        else if (dateTime.IsTomorrowOf(now))
                        {
                                if (isNeedSecondsField)
                                {
                                        caption = dateTime.ToString("明日 HH:mm:ss");
                                }
                                else
                                {
                                        caption = dateTime.ToString("明日 HH:mm");
                                }
                        }
                ...
                public static string ToDetailPageCaptionDefault(
                        this DateTime dateTime,
                        bool isNeedSecondsField = false)
                {
                        string caption;
