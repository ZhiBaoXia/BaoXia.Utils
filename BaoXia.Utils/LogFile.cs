...
namespace BaoXia.Utils
{
        public class LogFile : IDisposable
        {
                ...
                /// </summary>
                public const int MaxBytesCountPerLogFileDefault = (1024 * 1024);

                /// <summary>
                /// 单个日志文件最多字节数。
                /// </summary>
                public static Func<int>? ToGetMaxBytesCountPerLogFile { get; set; }
                ...
                public static void InitializeWithLogFilesDirectoryPath(
                        ...
                        Func<int>? toGetMaxBytesCountPerLogFile,
                ...
                protected bool DidTryStorageLogRecords(List<LogRecord> logRecordsNeedStorage)
                {
                        ...
                        while (logRecordsNeedStorage.Count > 0)
                        {
                                        ...
                                        logRecordIndex++)
                                {
                                        ...
                                        + "\r\n\t<content>" + logRecord.Content + "</content>"
                                        + "\r\n</log>";
                                }
